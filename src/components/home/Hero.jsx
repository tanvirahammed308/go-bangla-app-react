...
<div className='w-[450px] md:w-[580px] bg-white/70 mx-auto px-2 md:px-3 py-4  rounded text-center absolute bottom-20 md:bottom-40 left-[20px] md:left-[350px] shadow-2xl  text-gray-700 '>
