...
const ProductCard = ({item}) => {
  return (
    <div>
        <div className='w-96 bg-white shadow-lg rounded-lg overflow-hidden text-gray-600 border px-3 py-5'style={{borderRadius:"50px 0px 50px 0"}}>
            <div className=' rounded-md pt-3 px-3'>
            <img src={item.image_url} alt="" className='rounded-md h-40 w-full' style={{borderRadius:"50px 0px 50px 0"}}/>
            </div>
            <div className='card-body flex flex-col  h-[250px] mx-5' >
